...
function syncBodyScrollLock() {
  ...
  const navOpen = header?.classList.contains("is-open");
  const modalOpen =
    (privacy && !privacy.hasAttribute("hidden")) || (legal && !legal.hasAttribute("hidden"));
...
function initMobileNav() {
  ...
  nav.querySelectorAll(".site-nav__lang-btn").forEach((btn) => {
